...
/* The count value is used to specify the number of milliseconds the game main loop is idling */
#define GAME_DELEY_COUNT 20
/* The count to generate the delay for the display of the winner.*/
#define VICTORYSCREEN_DELAY_COUNT 5000
/* USER CODE END PD */
...
void HAL_SYSTICK_Callback(){
  ...
  if (systick_count % GAME_DELEY_COUNT == 0){
    game_delay = 1;
  }
  if (systick_count % VICTORYSCREEN_DELAY_COUNT == 0) {
	  victory_screen_delay = 1;
  }
  systick_count += 1;
}
